...
const ptBR: Dict = {
  ...
  // Categorias — título (.label) + descrição curta (.desc) por seção
  "cat.vendas": "AIMization Vendas",
  "cat.vendas.desc": "Ganhar, atender e vender para clientes.",
  "cat.estudio": "AIMization Estúdio",
  "cat.estudio.desc": "Criar o que comunica a marca, sem depender de agência.",
  "cat.inteligencia": "AIMization Inteligência",
  "cat.inteligencia.desc": "Ver os números e achar o que a empresa já sabe.",
  "cat.produtividade": "AIMization Produtividade",
  "cat.produtividade.desc": "Fazer o trabalho da equipe render, com menos esforço.",
  "cat.consultores": "AIMization Consultores",
  "cat.consultores.desc": "Consultoria para definir sua estratégia de marketing com IA.",
...
const en: Dict = {
  ...
  "cat.vendas": "AIMization Sales",
  "cat.vendas.desc": "Win, engage, and sell to customers.",
  "cat.estudio": "AIMization Studio",
  "cat.estudio.desc": "Create what communicates your brand, without relying on an agency.",
  "cat.inteligencia": "AIMization Intelligence",
  "cat.inteligencia.desc": "See the numbers and uncover what your business already knows.",
  "cat.produtividade": "AIMization Productivity",
  "cat.produtividade.desc": "Help your team get more done, with less effort.",
  "cat.consultores": "AIMization Consultants",
  "cat.consultores.desc": "Consulting to shape your marketing strategy with AI.",
